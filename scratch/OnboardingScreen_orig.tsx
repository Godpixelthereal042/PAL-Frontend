...
function AuthShell({ children, offset }: { children: ReactNode; offset: string }) {
  return (
    <div className={cn("mx-[20px] rounded-[30px] px-[30px] pb-[25px] pt-[25px] shadow-pal onb-white-card", offset)} style={{ color: 'var(--app-text)' }}>
      {children}
    </div>
  );
}
  ...
  return (
    <label className="block text-[12px] text-[var(--app-text)] text-left">
      ...
      <span className="relative mt-[7px] block">
        <input 
          className={cn(
            "auth-input bg-[var(--app-input-bg)] border-[var(--app-input-border)] text-[var(--app-text)]",
